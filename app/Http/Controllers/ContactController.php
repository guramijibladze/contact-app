...
class ContactController extends Controller
{
    ...
    public function store( Request $request )
    {
        $request->validate([
         ...
         return redirect()->route('contacts.index')->with('message', "Contacts has been added saccessfully");
    }
    ...
    public function update($id, Request $request)
    {
        ...
        $request->validate([
         ...
         return redirect()->route('contacts.index')->with('message', "Contacts has been update saccessfully");
    }
